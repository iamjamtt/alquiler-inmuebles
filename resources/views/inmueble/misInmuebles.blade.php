    ...
    @if (Auth::user()->estado == 1)
        <div class="py-12">
            ...
            <div class="p-6 px-10 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="text-xl flex justify-center font-bold">Mis Alquileres</div>
                ...
                <div class="p-6 bg-white border-b border-gray-200 md:flex md:justify-between md:items-center" >
                    ...
                    <div class="space-y-3 flex flex-col items-center justify-center">
                        <a href="{{route('detalle-alquiler',$item->id)}}" class="bg-amber-500 hover:bg-amber-600 cursor-pointer py-2 px-5 rounded-lg text-white text-sm font-bold uppercase w-36 text-center">
                            Ver Detalle
                        </a>
                    </div>
                </div>
